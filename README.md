...
An ultra-lightweight AI content blocker browser extension powered by regex-based pattern matching and linguistic analysis. It has an **average precision of about 80-90%** in correctly classifying _human text_, and an **average precision of around 80%** in detecting an _AI-generated corpus_.
...
3. Click **Load unpacked** and select the `dist` folder generated by the build operation.
...
2. Click **Load Temporary Add-on…** and select the `dist` folder generated by the build operation.
